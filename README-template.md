...
- analysing fonts and color for css variables
- writing css utility-classes for fonts and colors
- writing basic html
- basic layout via css 
- building out the mobil nav
- building out the slider.
...
- how to implement swipe-detection with the events 'touchstart' and 'touchmove'
- using :where() for no-specificity
- using column-property on a list
- addressing html elements with data-attributes and attribute-selector
